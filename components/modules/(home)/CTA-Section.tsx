      ...
      <div className="relative max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-gold400 text-xs tracking-[0.3em] uppercase">¿Listo para crecer?</span>
            <span className="w-10 h-px bg-gold400" />
          </div>
          ...
          <p className="text-ink200 text-lg mb-10 max-w-xl mx-auto leading-relaxed">
            Hablemos de tu empresa y descubre cómo podemos impulsar tu crecimiento con estrategias tributarias y
            contables a medida.
          </p>
